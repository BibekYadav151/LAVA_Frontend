...
const Navbar = () => {
  ...
  return (
    <>
      ...
      <div className={`fixed right-0 top-0 max-w-xs w-full h-full px-6 py-4 transition duration-300 transform overflow-y-auto bg-white border-l-2 border-gray-300 ${cartOpen ? 'translate-x-0 ease-out' : 'translate-x-full ease-in'} z-10`}>
        <div className="flex items-center justify-between">
        ...
        <div className="flex justify-between mt-6">
          <div className="flex">
            ...
            <div className="mx-3">
              ...
              <div className="flex items-center mt-2">
                <button className="text-gray-600 text-sm font-medium focus:outline-none">-</button>
          ...
          <div>
            <h3 className="text-sm text-gray-600">$1,799.00</h3>
          </div>
        </div>
        <div className="mt-4">
          <button className="bg-gray-800 text-white py-2 px-4 rounded w-full">Checkout</button>
        </div>
      </div>
    </>
  );
